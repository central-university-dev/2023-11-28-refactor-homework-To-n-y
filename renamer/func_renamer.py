...
class FuncRenameTransformer(libcst.CSTTransformer):
    ...
    def _rename_func_name(self, original_node, renamed_node):
    ...
    def _rename_func_call_name(self, original_node, renamed_node):
    ...
    def _rename_func_arg_name(self, original_node, renamed_node):
        try:
    ...
    def leave_FunctionDef(self, original_node, renamed_node):
        return self._rename_func_name(original_node, renamed_node)
    ...
    def leave_Call(self, original_node, renamed_node):
        return self._rename_func_call_name(original_node, renamed_node)

    def leave_Arg(self, original_node, renamed_node):
        return self._rename_func_arg_name(original_node, renamed_node)

    def leave_Assign(self, original_node, renamed_node):
        return self._rename_func_arg_name(original_node, renamed_node)


def rename_function(source_code: str, old_name: str, target_name: str) -> str:
    rename_transformer = FuncRenameTransformer(old_name, target_name)
